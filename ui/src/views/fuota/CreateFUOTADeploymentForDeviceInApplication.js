...
class CreateFUOTADeploymentForDeviceInApplication extends Component {
  constructor() {
    super();
    this.state = {};
...
export default withStyles(styles)(withRouter(CreateFUOTADeploymentForDeviceInApplication));
